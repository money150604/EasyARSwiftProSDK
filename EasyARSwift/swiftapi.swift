...
let TypeNameToConstructor: [String : (OpaquePointer) -> RefBase] = [
    ...
    "ARScene": { cdata in ARScene(cdata: cdata, deleter: easyar_ARScene__dtor) },
    "ARSceneTracker": { cdata in ARSceneTracker(cdata: cdata, deleter: easyar_ARSceneTracker__dtor) },
]
...
fileprivate func ListOfPointerOfObjectTarget_to_c(_ l: [ObjectTarget]) -> OpaquePointerContainer {
    ...
    arr.withUnsafeBufferPointer { bp in
        easyar_ListOfPointerOfObjectTarget__ctor(UnsafePointer<OpaquePointer>(bp.baseAddress), UnsafePointer<OpaquePointer>(bp.baseAddress?.advanced(by: bp.count)), pptr)
    }
    return OpaquePointerContainer(pptr.pointee, { p in easyar_ListOfPointerOfObjectTarget__dtor(p) })
}
fileprivate func ListOfPointerOfObjectTarget_from_c(_ l: OpaquePointerContainer) -> [ObjectTarget] {
    let size = Int(easyar_ListOfPointerOfObjectTarget_size(l.ptr_))
    var values = [ObjectTarget]()
    values.reserveCapacity(size)
    for k in 0..<size {
        var v = easyar_ListOfPointerOfObjectTarget_at(l.ptr_, Int32(k))
        easyar_ObjectTarget__retain(v, &v)
        values.append((Object_from_c(v, easyar_ObjectTarget__typeName) as ObjectTarget))
    }
    return values
}

fileprivate func ListOfVec3F_to_c(_ l: [Vec3F]) -> OpaquePointerContainer {
    ...
    return OpaquePointerContainer(pptr.pointee, { p in easyar_ListOfVec3F__dtor(p) })
}
fileprivate func ListOfVec3F_from_c(_ l: OpaquePointerContainer) -> [Vec3F] {
...
fileprivate func FunctorOfVoidFromRecordStatusAndString_func(_ state: OpaquePointer, _ arg0: Int32, _ arg1: OpaquePointer) -> Void {
...
fileprivate func FunctorOfVoidFromRecordStatusAndString_to_c(_ f: @escaping (RecordStatus, String) -> Void) -> easyar_FunctorOfVoidFromRecordStatusAndString {
    ...
    s.initialize(to: f)
    return easyar_FunctorOfVoidFromRecordStatusAndString(_state: OpaquePointer(s), _func: FunctorOfVoidFromRecordStatusAndString_func, _destroy: { p in UnsafeMutablePointer<(RecordStatus, String) -> Void>(p).deinitialize() })
}
...
public class ObjectTarget : Target {
    ...
    public func setup(_ path: String, _ storageType: Int32, _ name: String) -> Bool {
        let _return_value_ = easyar_ObjectTarget_setup(cdata_, String_to_c(path).ptr_, storageType, String_to_c(name).ptr_)
        return _return_value_
    }
    public static func setupAll(_ path: String, _ storageType: Int32) -> [ObjectTarget] {
        let _return_value_ = UnsafeMutablePointer<OpaquePointer>.allocate(capacity: 1)
        defer {
            _return_value_.deinitialize()
        }
        easyar_ObjectTarget_setupAll(String_to_c(path).ptr_, storageType, _return_value_)
        return ListOfPointerOfObjectTarget_from_c(OpaquePointerContainer(_return_value_.pointee, { p in easyar_ListOfPointerOfObjectTarget__dtor(p) }))
    }
    ...
    public func boundingBox() -> [Vec3F] {
        ...
        return ListOfVec3F_from_c(OpaquePointerContainer(_return_value_.pointee, { p in easyar_ListOfVec3F__dtor(p) }))
    }
    public func boundingBoxGL() -> [Vec3F] {
        let _return_value_ = UnsafeMutablePointer<OpaquePointer>.allocate(capacity: 1)
        defer {
            _return_value_.deinitialize()
        }
    ...
    public override func setMeta(_ data: String) -> Void {
        easyar_ObjectTarget_setMeta(cdata_, String_to_c(data).ptr_)
    }
}

public class ObjectTracker : TargetTracker {
    fileprivate override init(cdata: OpaquePointer, deleter: @escaping (OpaquePointer) -> Void) {
        super.init(cdata: cdata, deleter: deleter)
    }
    public convenience init() {
        ...
        self.init(cdata: _return_value_.pointee, deleter: { ptr in easyar_ObjectTracker__dtor(ptr) })
    }
    public override func loadTarget(_ target: Target, _ callback: @escaping (Target, Bool) -> Void) -> Void {
        easyar_ObjectTracker_loadTarget(cdata_, target.cdata_, FunctorOfVoidFromPointerOfTargetAndBool_to_c(callback))
    }
    public override func unloadTarget(_ target: Target, _ callback: @escaping (Target, Bool) -> Void) -> Void {
        easyar_ObjectTracker_unloadTarget(cdata_, target.cdata_, FunctorOfVoidFromPointerOfTargetAndBool_to_c(callback))
    }
    public override func loadTargetBlocked(_ target: Target) -> Bool {
        let _return_value_ = easyar_ObjectTracker_loadTargetBlocked(cdata_, target.cdata_)
        return _return_value_
    }
    public override func unloadTargetBlocked(_ target: Target) -> Bool {
        let _return_value_ = easyar_ObjectTracker_unloadTargetBlocked(cdata_, target.cdata_)
        return _return_value_
    }
    ...
    public override func attachStreamer(_ obj: FrameStreamer?) -> Bool {
        let _return_value_ = easyar_ObjectTracker_attachStreamer(cdata_, obj.map({(p) in p.cdata_}))
        return _return_value_
    }
    ...
    public override func stop() -> Bool {
        let _return_value_ = easyar_ObjectTracker_stop(cdata_)
        return _return_value_
    }
}
...
public struct RecordProfile : OptionSet {
    public let rawValue: Int32
    public init(rawValue: Int32) { self.rawValue = rawValue }
    
    public static let Quality_1080P_Low = RecordProfile(rawValue: 0x00000001)
    public static let Quality_1080P_Middle = RecordProfile(rawValue: 0x00000002)
    public static let Quality_1080P_High = RecordProfile(rawValue: 0x00000004)
    public static let Quality_720P_Low = RecordProfile(rawValue: 0x00000008)
    public static let Quality_720P_Middle = RecordProfile(rawValue: 0x00000010)
    public static let Quality_720P_High = RecordProfile(rawValue: 0x00000020)
    public static let Quality_480P_Low = RecordProfile(rawValue: 0x00000040)
    public static let Quality_480P_Middle = RecordProfile(rawValue: 0x00000080)
    public static let Quality_480P_High = RecordProfile(rawValue: 0x00000100)
    public static let Quality_Default = RecordProfile(rawValue: 0x00000010)
}

public struct RecordVideoSize : OptionSet {
    public let rawValue: Int32
    public init(rawValue: Int32) { self.rawValue = rawValue }
    
    public static let Vid1080p = RecordVideoSize(rawValue: 0x00000002)
    public static let Vid720p = RecordVideoSize(rawValue: 0x00000010)
    public static let Vid480p = RecordVideoSize(rawValue: 0x00000080)
}

public struct RecordZoomMode : OptionSet {
    public let rawValue: Int32
    public init(rawValue: Int32) { self.rawValue = rawValue }
    
    public static let NoZoomAndClip = RecordZoomMode(rawValue: 0x00000000)
    public static let ZoomInWithAllContent = RecordZoomMode(rawValue: 0x00000001)
}

public struct RecordVideoOrientation : OptionSet {
    public let rawValue: Int32
    public init(rawValue: Int32) { self.rawValue = rawValue }
    
    public static let Landscape = RecordVideoOrientation(rawValue: 0x00000000)
    public static let Portrait = RecordVideoOrientation(rawValue: 0x00000001)
}

public struct RecordStatus : OptionSet {
    public let rawValue: Int32
    public init(rawValue: Int32) { self.rawValue = rawValue }
    
    public static let OnStarted = RecordStatus(rawValue: 0x00000002)
    public static let OnStopped = RecordStatus(rawValue: 0x00000004)
    public static let FailedToStart = RecordStatus(rawValue: 0x00000202)
    public static let FileSucceeded = RecordStatus(rawValue: 0x00000400)
    public static let FileFailed = RecordStatus(rawValue: 0x00000401)
    public static let LogInfo = RecordStatus(rawValue: 0x00000800)
    public static let LogError = RecordStatus(rawValue: 0x00001000)
}
...
public class Recorder : RefBase {
    ...
    public convenience init() {
        ...
        self.init(cdata: _return_value_.pointee, deleter: { ptr in easyar_Recorder__dtor(ptr) })
    }
    public func setOutputFile(_ path: String) -> Void {
        easyar_Recorder_setOutputFile(cdata_, String_to_c(path).ptr_)
    }
    public func setInputTexture(_ texPtr: OpaquePointer, _ width: Int32, _ height: Int32) -> Void {
        easyar_Recorder_setInputTexture(cdata_, texPtr, width, height)
    }
    public func requestPermissions(_ permissionCallback: @escaping (PermissionStatus, String) -> Void) -> Void {
        easyar_Recorder_requestPermissions(cdata_, FunctorOfVoidFromPermissionStatusAndString_to_c(permissionCallback))
    }
    public func `open`(_ statusCallback: @escaping (RecordStatus, String) -> Void) -> Bool {
        let _return_value_ = easyar_Recorder_open(cdata_, FunctorOfVoidFromRecordStatusAndString_to_c(statusCallback))
        return _return_value_
    }
    ...
    public func setProfile(_ profile: RecordProfile) -> Bool {
        let _return_value_ = easyar_Recorder_setProfile(cdata_, profile.rawValue)
        return _return_value_
    }
    public func setVideoSize(_ framesize: RecordVideoSize) -> Void {
        easyar_Recorder_setVideoSize(cdata_, framesize.rawValue)
    }
    public func setVideoBitrate(_ bitrate: Int32) -> Void {
        easyar_Recorder_setVideoBitrate(cdata_, bitrate)
    }
    public func setChannelCount(_ count: Int32) -> Void {
        easyar_Recorder_setChannelCount(cdata_, count)
    }
    public func setAudioSampleRate(_ samplerate: Int32) -> Void {
        easyar_Recorder_setAudioSampleRate(cdata_, samplerate)
    }
    public func setAudioBitrate(_ bitrate: Int32) -> Void {
        easyar_Recorder_setAudioBitrate(cdata_, bitrate)
    }
    public func setVideoOrientation(_ mode: RecordVideoOrientation) -> Void {
        easyar_Recorder_setVideoOrientation(cdata_, mode.rawValue)
    }
    public func setZoomMode(_ mode: RecordZoomMode) -> Void {
        easyar_Recorder_setZoomMode(cdata_, mode.rawValue)
    }
}

public class ARScene : Target {
    fileprivate override init(cdata: OpaquePointer, deleter: @escaping (OpaquePointer) -> Void) {
        super.init(cdata: cdata, deleter: deleter)
    }
    public convenience init() {
        ...
        self.init(cdata: _return_value_.pointee, deleter: { ptr in easyar_ARScene__dtor(ptr) })
    }
    public override func runtimeID() -> Int32 {
        let _return_value_ = easyar_ARScene_runtimeID(cdata_)
        return _return_value_
    }
    public override func uid() -> String {
        let _return_value_ = UnsafeMutablePointer<OpaquePointer>.allocate(capacity: 1)
    ...
    public override func setMeta(_ data: String) -> Void {
        easyar_ARScene_setMeta(cdata_, String_to_c(data).ptr_)
    }
}

public class ARSceneTracker : FrameFilter {
    fileprivate override init(cdata: OpaquePointer, deleter: @escaping (OpaquePointer) -> Void) {
        super.init(cdata: cdata, deleter: deleter)
    }
    public convenience init() {
        ...
        self.init(cdata: _return_value_.pointee, deleter: { ptr in easyar_ARSceneTracker__dtor(ptr) })
    }
    public override func attachStreamer(_ obj: FrameStreamer?) -> Bool {
        let _return_value_ = easyar_ARSceneTracker_attachStreamer(cdata_, obj.map({(p) in p.cdata_}))
        return _return_value_
    }
    public override func start() -> Bool {
        let _return_value_ = easyar_ARSceneTracker_start(cdata_)
        return _return_value_
    }
    public override func stop() -> Bool {
        let _return_value_ = easyar_ARSceneTracker_stop(cdata_)
        return _return_value_
    }
}
